...
This project is based on  **[Hyperspectral-Classification](https://github.com/eecn/Hyperspectral-Classification)**, I made some improvements and fixed some bugs. 

## New dataset and New model

**Hyperspectral water quality dataset** was added as **custom dataset.**

![纯净水与凌水河水样对照展示图](README.assets/纯净水与凌水河水样对照展示图.png)

**M3D-RES-DCNN** was added as **custom model.**
...
The OwnData and OwnNet belong to **Guangxin Han**, **Zichen Li**,  **Chuanlei Sun**, students of DaLian University of Technology, and **Xiaorui Ma**, teacher of DaLian University of Technology.

**If you want them for any use, please contact 734167802@qq.com for permission!**
